...
public class AdsViewPagerAdapter extends PagerAdapter {
    ...
    public AdsViewPagerAdapter(Context context, List<NewsAdsDataModel> list) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.ads_row,container,false);
        ImageView imageView=view.findViewById(R.id.adsImage);
        Glide.with(context).load(list.get(position).getFileurl()).error(R.drawable.placeholder).into(imageView);
